      ...
      L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
        ...
        */
        locateOnLine: function(map, polyline, latlng) {
          ...
          for (var i = 0, n = latlngs.length - 1; i < n; i++) {
            ...
            portion = lengths[i];
            if (L.GeometryUtil.belongsSegment(point, l1, l2, 1e-3)) {
        ...
        */
        ...
        extract: function(map, polyline, start, end) {
          if (start > end) {
            return L.GeometryUtil.extract(map, L.GeometryUtil.reverse(polyline), 1 - start, 1 - end);
          }
        ...
        */
        destinationOnSegment: function(map, latlngA, latlngB, distance) {
          var angleDeg = L.GeometryUtil.angle(map, latlngA, latlngB), latlng = L.GeometryUtil.destination(latlngA, angleDeg, distance);
...
export default require_leaflet_geometryutil();
//# sourceMappingURL=leaflet-geometryutil.js.map
