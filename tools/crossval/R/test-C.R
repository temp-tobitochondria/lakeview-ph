...
out_path <- if (length(args) >= 1) args[[1]] else 'tools/crossval/C/out.json'
...
LakeA_range <- c(
  7.3, 7.3, 7.8, 7.4, 7.4, 7.3, 7.6, 7.0, 6.8, 7.3, 7.0, 6.9, 7.5, 7.4, 7.3, 6.9, 7.3, 8.0, 7.0, 6.8, 7.1, 6.9, 7.0, 6.5, 6.8, 6.7, 7.8, 6.9, 6.8, 6.8, 6.4, 6.6, 6.6, 6.6, 6.8, 7.0, 6.7, 6.9, 6.7, 6.6, 6.8, 6.8, 7.0, 7.2, 7.0, 6.9, 6.8, 6.7, 7.2, 7.3, 7.2, 6.8, 7.3, 6.8, 6.8, 6.7, 6.5, 7.0, 6.9, 6.8, 6.6, 6.6, 6.6, 6.7, 6.6, 6.5, 7.0, 6.5, 6.5, 6.9, 6.7, 7.2, 6.8, 6.7
)
lower <- 6.5; upper <- 8.5
